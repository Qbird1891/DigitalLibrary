...
public class ViewAllListsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<LibraryDetails> abc = slh.getLists();
		request.setAttribute("allLibraries", abc);
		if (abc.isEmpty()) {
			request.setAttribute("allLibraries", " ");
		}
		getServletContext().getRequestDispatcher("/library-list-by-user.jsp").forward(request, response);
	}
